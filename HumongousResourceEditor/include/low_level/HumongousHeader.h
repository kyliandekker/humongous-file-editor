...
#pragma pack(push, 1)
		...
		public:
			...
			HumongousHeader(const char* a_ChunkID, uint32_t a_ChunkSize = 0, bool a_BigEndian = true);
			HumongousHeader(unsigned char* a_ChunkID, uint32_t a_ChunkSize = 0, bool a_BigEndian = true);
