...
#pragma pack(push, 1)
		...
		{
			RIFF_Chunk() = default;
			RIFF_Chunk(const char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
			RIFF_Chunk(unsigned char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
		...
		*/
		...
		{
			FMT_Chunk() = default;
			FMT_Chunk(const char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
			FMT_Chunk(unsigned char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
		...
		*/
		...
		{
			DATA_Chunk() = default;
			DATA_Chunk(const char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
			DATA_Chunk(unsigned char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
		...
		*/
		...
		{
			ACID_Chunk() = default;
			ACID_Chunk(const char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
			ACID_Chunk(unsigned char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
		...
		*/
		...
		{
			BEXT_Chunk() = default;
			BEXT_Chunk(const char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
			BEXT_Chunk(unsigned char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
		...
		*/
		...
		{
			FACT_Chunk() = default;
			FACT_Chunk(const char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
			FACT_Chunk(unsigned char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
		...
		*/
		...
		{
			CUE_Chunk() = default;
			CUE_Chunk(const char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
			CUE_Chunk(unsigned char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
		...
		*/
		...
		{
			SMPL_Chunk() = default;
			SMPL_Chunk(const char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
			SMPL_Chunk(unsigned char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
		...
		*/
		...
		{
			INST_Chunk() = default;
			INST_Chunk(const char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
			INST_Chunk(unsigned char* a_ChunkID) : ChunkHeader(a_ChunkID)
			{ }
