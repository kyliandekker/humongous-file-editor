...
namespace HumongousFileEditor
{
	...
	public:
		...
		static bool GetDataSMAP(chunk_reader::FileContainer*& fc, size_t width, size_t height, chunk_reader::SMAP_Chunk& smap_chunk, chunk_reader::APAL_Chunk& apal_chunk, img_info& info);
